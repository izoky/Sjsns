...
async def restart(client, m: Message):
    ...
    await jmthon.edit("8")
    await jmthon.edit("9")
    await jmthon.edit("**تم اعادة تشغيل سورس سيمو ميوزك بنجاح ✓**")
...
🛠 هذه هي قائمـة اوامر السـورس اي مشاكل هنا رجاء تواصل @K_E_S_H
...
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك سيمو @K_E_S_H
